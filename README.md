...
> 10-30 修复B站接口失效导致无法正常签到、送小心心  
> 11-1  修复Server酱推送失败问题，概率无法赠送所有小心心问题
...
免费、稳定、无需服务器、零基础部署  
缺点：  
由于腾讯云函数限制了最长15分钟运行时间，所以至少需要**9**个粉丝牌才能拿满24个小心心。同时如果要想运行后续签到，则必须要至少**12**个牌子，否则云函数会超值报错，但是任然会得到24个小心心  
